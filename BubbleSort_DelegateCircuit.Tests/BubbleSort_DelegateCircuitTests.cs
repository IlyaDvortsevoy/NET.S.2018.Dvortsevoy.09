...
using BubbleSort_DelegateCircuitTests.TestTypes;
using NUnit.Framework;

namespace BubbleSort_DelegateCircuit.Tests
{
    [TestFixture]
    public class BubbleSort_DelegateCircuitTests
    {
        ...
        {
            BubbleSort_delegate.Sort(initial, new SumSortDesc());
